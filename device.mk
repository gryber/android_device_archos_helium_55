...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/archos/helium_55/prebuilt/Image.gz-dtb
else
...
PRODUCT_COPY_FILES += \
    device/archos/helium_55/rootdir/init.rc:root/init.rc \
    device/archos/helium_55/rootdir/init.target.rc:root/init.target.rc \
    device/archos/helium_55/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/archos/helium_55/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/archos/helium_55/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/archos/helium_55/rootdir/init.usb.rc:root/init.usb.rc \
    device/archos/helium_55/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/archos/helium_55/rootdir/init.aee.rc:root/init.aee.rc \
    device/archos/helium_55/rootdir/init.project.rc:root/init.project.rc \
    device/archos/helium_55/rootdir/init.modem.rc:root/init.modem.rc \
    device/archos/helium_55/rootdir/init.trace.rc:root/init.trace.rc \
    device/archos/helium_55/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/archos/helium_55/rootdir/fstab.swap:root/fstab.swap \
    device/archos/helium_55/rootdir/ueventd.rc:root/ueventd.rc \
    device/archos/helium_55/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/archos/helium_55/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/archos/helium_55/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/archos/helium_55/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/archos/helium_55/etc/init/rild.rc:system/etc/init/rild.rc \
    device/archos/helium_55/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/archos/helium_55/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
# PRODUCT_COPY_FILES += \
#    vendor/archos/helium_55/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_EXTRA_RECOVERY_KEYS += device/archos/helium_55/mts
